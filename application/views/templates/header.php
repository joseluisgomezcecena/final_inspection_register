<!DOCTYPE html>
<html lang="en" dir="ltr" class="theme-emerald font-roboto-condensed-roboto menu-hidden">

<head>
	<meta charset="UTF-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />

	<title>Inspección Final - Registro de Calidad </title>


	<!-- Generics -->
	<link rel="icon" href="<?php echo base_url() ?>/assets/images/favicon/favicon.png" sizes="32x32">
	<link rel="icon" href="<?php echo base_url() ?>/assets/images/favicon/favicon.png" sizes="128x128">
	<link rel="icon" href="<?php echo base_url() ?>/assets/images/favicon/favicon.png" sizes="192x192">

	<!-- Android -->
	<link rel="shortcut icon" href="<?php echo base_url() ?>/assets/images/favicon/favicon.png" sizes="196x196">

	<!-- iOS -->
	<link rel="apple-touch-icon" href="<?php echo base_url() ?>/assets/images/favicon/favicon.png" sizes="152x152">
	<link rel="apple-touch-icon" href="<?php echo base_url() ?>/assets/images/favicon/favicon.png" sizes="167x167">
	<link rel="apple-touch-icon" href="<?php echo base_url() ?>/assets/images/favicon/favicon.png" sizes="180x180">
...
<header class="top-bar">
	...
	<!-- Brand -->
	<span class="brand">Registro de calidad</span>
...
<main class="workspace overflow-hidden">
	...
	<?php if($this->session->flashdata('user_registered')): ?>
		...
		<div class="alert alert_outlined alert_info">
			...
			El usuario fue registrado con exito, todas las contraseñas son 123456 por defecto.
